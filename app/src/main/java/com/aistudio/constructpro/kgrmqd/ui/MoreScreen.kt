...
import com.aistudio.constructpro.kgrmqd.ui.theme.*
                        ...
                        onSignOut = {
                            try {
                                val gso = GoogleSignInOptions
                                    ...
                                    .requestIdToken(com.aistudio.constructpro.kgrmqd.BuildConfig.GOOGLE_OAUTH_CLIENT_ID)
                                    .requestEmail().build()
...
private fun PremiumThemeBackupCard(
    ...
    Column(
        ...
        Row(
            ...
            Switch(
                ...
                onCheckedChange = { enabled ->
                    ...
                    if (enabled) {
                        com.aistudio.constructpro.kgrmqd.AutoBackupWorker.schedule(context)
        ...
        if (hasDrivePermission) {
            ...
            var logsList by remember { mutableStateOf<List<com.aistudio.constructpro.kgrmqd.BackupLogItem>>(emptyList()) }

            LaunchedEffect(Unit) {
                logsList = com.aistudio.constructpro.kgrmqd.BackupLogger.readLogs(context)
            }
                    ...
                    PremiumGradientButton(
                        ...
                        onClick = {
                            coroutineScope.launch {
                                manualSyncing = true
                                val res = com.aistudio.constructpro.kgrmqd.AutoBackupWorker.performBackupUpload(context)
                                manualSyncing = false
                                logsList = com.aistudio.constructpro.kgrmqd.BackupLogger.readLogs(context)
                                if (res.success) {
